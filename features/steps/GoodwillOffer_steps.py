...
@when('I submit a Goodwill offer using "{payload_file}"')
...
@then("the Goodwill response status code should be {expected_status:d}")
...
@then("the Goodwill response should contain {field}")
...
@then('the Goodwill response status should be "{expected_status}"')
