...
@then("the response BasicMass status code should be {expected_status:d}")# type: ignore
...
@then("the response BasicMass should contain {field}")# type: ignore
...
@then('the response BasicMass status should be "{expected_status}"')# type: ignore
