...
@when('I submit a PartnerBasicMass offer using "{payload_file}"')
...
@then("the PartnerBasicMass response status code should be {expected_status:d}")
...
@then("the PartnerBasicMass response should contain {field}")
...
@then('the PartnerBasicMass response status should be "{expected_status}"')
